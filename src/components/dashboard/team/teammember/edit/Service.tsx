...
export default function AddTeamMemberService({ serviceRef, selectedServices, setSelectedServices, teamMember }: Props) {
    ...
    // console.log(teamMember, teamMember?.services)
    // console.log(selectedServices)
    // useEffect(() => {
    //     if (teamMember) {
    //         const initialServices = teamMember.services.map((service) => String(service.id))
    //         console.log(initialServices)
    //         setSelectedServices(initialServices);
    //     }
    // }, [teamMember, AllCategories])
