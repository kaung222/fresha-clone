...
export default function SuccessPublication() {
    ...
    return (
        <div className=" w-screen h-h-screen-minus-80 bg-white fixed left-0 top-[80px] z-20 flex justify-center items-center ">
            <div className=" w-full h-full overflow-auto ">
                <div className=" p-10 ">
                    <Card className="w-full max-w-md mx-auto my-auto mt-10">
                        <CardContent className="pt-6 px-6 pb-20">
                            <div className="flex flex-col items-center text-center space-y-4 mb-8">
                                <CheckCircle2 className="w-16 h-16 text-emerald-500" />
                                <h1 className="text-2xl font-semibold">Your Business profile is ready!</h1>
