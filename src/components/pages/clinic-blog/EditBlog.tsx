...
import { useUpdatePost } from "@/api/post/update-post";
...
export default function BlogEdit({ blog }: Props) {
  ...
  const [images, setImages] = useState<string[]>(blog.images as string[]);
  ...
  const imageArray: string[] | undefined = form.watch("images");
